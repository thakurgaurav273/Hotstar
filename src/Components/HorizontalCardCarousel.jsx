...
const slidePrev = () => {
  ...
  return (
    <div className="carousel-container hori-carousel-container">
      <div
        className="carousel"
        ref={carouselRef}
      >
      ...
      <button className="hori prev-button" onClick={slidePrev} disabled={prevTranslate >= 0}>
        <i className="fa-solid fa-chevron-left"></i>
      </button>
      <button className="hori next-button" onClick={slideNext}>
