...
export default function Top(){
    return(<>
        <div className='top-content'>
          ...
          <img alt="pic_is_there"className='top-image' src='https://shifu.hotstarext.com/SOURCE/VOD/cd-2023-05-29/WTCDated_deskXbb-86b250ab-6af0-4638-8d8d-627fe9415cf8.jpg'/>
          <div className='desc'>
